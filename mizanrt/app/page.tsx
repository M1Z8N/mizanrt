...
import MobileMusicSummary from './components/MobileMusicSummary'
      ...
      <section className="home-section" style={{ padding: '40px 24px 96px 24px' }}>
        <div className="home-grid">
          <div className="home-main">
            ...
            <p style={{ margin: 0, textTransform: 'lowercase', letterSpacing: 1, opacity: 0.9 }}>building <u><a href="https://dock.inc" target="_blank" rel="noopener noreferrer " style={{ color: 'inherit', textDecoration: 'none' }}> dock(yc f25)</a></u></p>
